    ...
    return (
        ...
        <KeyboardAwareScrollView keyboardDismissMode='on-drag' scrollEnabled={false} className="bg-[#151515]">
            ...
            <View className="py-4 mt-20 flex justify-center items-center">
                <Text className="text-4xl text-white font-bold ">What are you looking for?</Text>
                <Text className="text-md text-white font-bold mx-6 mt-10 ">Select the option(s) that reflect what you're looking for.</Text>
            ...
            <TouchableOpacity className="bg-[#ffba03] rounded-full mx-8 py-4 mb-12 mt-auto"
                onPress={() => {
                    if(state.lookingFor?.length > 0) {
                        navigation.push({pathname: '/setup/interests/location'});
                    }
                    else
                        dispatch({type: 'setError', payload: 'Select atleast one option!'});
                                }}>
