...
import { Alert, Text, TouchableOpacity, View, KeyboardAvoidingView, ScrollView  } from 'react-native'
      ...
      <ScrollView keyboardDismissMode='on-drag' scrollEnabled={false}>
        <KeyboardAvoidingView behavior="position" >
          <View className='self-stretch mt-32'>
            <Text className='text-4xl mb-12 mt-20 text-white font-bold text-center'>Sign Up</Text>
            <Input
